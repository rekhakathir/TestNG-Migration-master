...
@Target({ METHOD, TYPE })
public @interface DeltaDataProvider {
	/**
	...
	public static final String NAME= "delta-data-provider";
	public static final String NAME_PARALLEL = "delta-data-provider-parallel";

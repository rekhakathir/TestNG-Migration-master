...
import src.main.java.util.WaitUtil;
...
public class BaseTestPage {
     ...
     */
    public boolean isAbsent(final By locator) {
        try {
     ...
     * @return returns true if element is absent, else false.
     */
    public boolean isAbsent(final WebElement element) {
        if(element == null)
        {
            return true;
        }
     ...
     * @return returns true if element is absent, else false.
     */
    public ExpectedCondition<Boolean> isAbsentConditional(final By locator) {
     ...
     * @return returns true if element is absent, else false.
     */
    public ExpectedCondition<Boolean> isAbsentConditional(final WebElement element) {
        return new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver webDriver) {
                try {
     ...
     * @throws Exception 
     */
    public void clickOnElementUsingAction(By locator) throws Exception {
     ...
     * @throws Exception 
     */
    public void clickOnElementUsingAction(WebElement element) throws Exception {
     ...
     * @param locator the element By selector
     */
    public void clickThenWaitForElementToDisappear(By locator) {
        clickThenWaitForElementToDisappear(locator, DEFAULT_TIMEOUT);
    }
     ...
     */
    public void clickThenWaitForElementToDisappear(By locator, int seconds) {
        try {
            clickElement(locator);
            wait.untilElementDisappears(locator, seconds, WAIT_POLL_TIMEOUT);

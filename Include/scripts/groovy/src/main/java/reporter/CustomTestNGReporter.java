...
public class CustomTestNGReporter implements IReporter {
    ...
    private static final String emailableReportTemplateFile = "./templates/customize-emailable-report-template.html";
	 ...
	 * suites, String outputDirectory) {
	 * 
	 * try { // Get content data in TestNG report template file. String
	 * customReportTemplateStr = this.readEmailabelReportTemplate();
	 * 
	 * // Create custom report title. String customReportTitle =
	 * this.getCustomReportTitle("DeltaDental Custom TestNG Automation Report");
	 * 
	 * // Create test suite summary data. String customSuiteSummary =
	 * this.getTestSuiteSummary(suites);
	 * 
	 * // Create test methods summary data. String customTestMethodSummary =
	 * this.getTestMehodSummary(suites);
	 * //Log.info("Test Method Summary: "+customTestMethodSummary);
	 * 
	 * // Replace report title place holder with custom title.
	 * customReportTemplateStr =
	 * customReportTemplateStr.replaceAll("\\$TestNG_Custom_Report_Title\\$",
	 * customReportTitle);
	 * 
	 * // Replace test suite place holder with custom test suite summary.
	 * customReportTemplateStr =
	 * customReportTemplateStr.replaceAll("\\$Test_Case_Summary\\$",
	 * customSuiteSummary);
	 * 
	 * // Replace test methods place holder with custom test method summary.
	 * customReportTemplateStr =
	 * customReportTemplateStr.replaceAll("\\$Test_Case_Detail\\$",
	 * customTestMethodSummary);
	 * 
	 * // Write replaced test report content to custom-emailable-report.html. File
	 * targetFile = new File(outputDirectory + "/custom-emailable-report.html");
	 * FileWriter fw = new FileWriter(targetFile);
	 * fw.write(customReportTemplateStr); fw.flush(); fw.close();
	 * 
